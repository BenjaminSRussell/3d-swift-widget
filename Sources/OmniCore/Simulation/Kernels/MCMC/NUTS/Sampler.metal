...
inline NUTSParticle leapfrog_step(NUTSParticle p, float epsilon) {
    NUTSParticle next = p;
...
kernel void nuts_sampler(
    device NUTSParticle* particles [[buffer(0)]],
