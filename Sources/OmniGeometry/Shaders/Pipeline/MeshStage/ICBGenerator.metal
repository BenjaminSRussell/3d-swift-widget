...
kernel void update_icb(
    ...
    if (tid == 0) {
        ...
        // args: threadsPerObjectThreadgroup, threadsPerMeshThreadgroup, threadgroupsPerGrid
        cmd.draw_mesh_threadgroups(
            uint3(1, 1, 1), // threadsPerObjectThreadgroup
            uint3(1, 1, 1), // threadsPerMeshThreadgroup
            uint3(10, 10, 1) // threadgroupsPerGrid (100 patches)
        );
    }
}
